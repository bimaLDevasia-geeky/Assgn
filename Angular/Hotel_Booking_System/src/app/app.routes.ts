...
export const routes: Routes = [
    ...
    {path:"customers/:id",loadComponent: () => import('./features/customers/customer-details/customer-details').then(m => m.CustomerDetails)},
    {path:"hotels",loadComponent:()=> import('./features/hotels/hotels-list/hotels-list').then(m => m.HotelsList)},
    {path:"hotels/:id",loadComponent:()=> import('./features/hotels/hotels-details/hotels-details').then(m => m.HotelsDetails),
