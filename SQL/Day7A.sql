...
from 
    Appointments A
left join 
    Prescriptions P ON P.PatientID = A.PatientID
                   AND P.PrescriptionDate = A.AppointmentDate 
where 
    Year(A.AppointmentDate) = Year(getdate()) - 1;
...
select distinct D.Specialty, M.MedicationName
from Doctors D  
